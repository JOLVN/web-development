  ...
  return (
    <div className={ styles.product }>
        <div>
          ...
          <div><img className={styles.image} src={props.image} alt={props.image} /></div>
          ...
          {props.isAvailable
          ? <div className={styles.price}>${props.price} {props.shippingPrice ? <span className={styles.shippingPrice}>+ ${props.shippingPrice} shipping</span> : ''} </div>
